...
public class QueryUtils {
    ...
    public static String fetchTranslation(String requestUrl) {
        ...
        try {
            ...
            Log.e("fetchTranslation", "Error closing input stream", e);
        }
     ...
     */
    public static String extractTranslation(String translationJSON) {
        ...
        try {
            ...
            // create json object first from the string
            JSONObject root = new JSONObject(translationJSON);
            JSONObject dataElement = root.getJSONObject("data");
            JSONArray translationsArray = dataElement.getJSONArray("translations");
            JSONObject translationElement = translationsArray.getJSONObject(0);
            translation = translationElement.getString("translatedText");
